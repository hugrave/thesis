...
if __name__ == '__main__':
    ...
    for i in pbar:
        ...
        # print(latent_in.shape, imgs.shape, latent_n.shape)
    ...
    filename = os.path.splitext(os.path.basename(args.files[0]))[0] + '-single.pt'

    img_ar = make_image(img_gen)

    for i, input_name in enumerate(args.files):
        result_file[input_name] = {'img': img_gen[i], 'latent': latent_in[i]}
        img_name = os.path.splitext(os.path.basename(input_name))[0] + '-project-single.png'
